...
class Aliments:
        ...
        for key, value in aliments_by_categorie.items():
            for element_dict in value:
                if "stores" in element_dict.keys():
                    list_all.append(Aliments(url=element_dict["url"], stores=element_dict["stores"],nutrition_grades=element_dict["nutrition_grades"], product_name=element_dict["product_name"], id_off=element_dict["id"], categorie=key))
                else:
    ...
    def filter_key(dict_of_categorie):
        ...
        check = ["nutrition_grades", "product_name", "categories", "url"]
        clean_list = []
